...
public class GameBoard implements Serializable {
    ...
    private  ArrayList<AnswerWord> answerlist; // 맞춘 정답 리스트
    ...
    private int stage; // 현재 게임판의 스테이지
    private String difficulty; // 현재 게임판의 난이도
    ...
    public GameBoard(String _difficulty, int _stage, StagePropertyInfo _stageinfo,
                     List<String> _wordlist, List<String>_hintlist, int _userlevel ) {
        // 매개변수 대입
